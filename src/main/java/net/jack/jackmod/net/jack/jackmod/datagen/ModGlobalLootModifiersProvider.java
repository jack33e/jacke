...
import net.jack.jackmod.loot.AddItemModifier;
import net.jack.jackmod.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("metal_detector_from_suspicous_sand", new AddSusSandItemModifier(new LootItemCondition[] {
